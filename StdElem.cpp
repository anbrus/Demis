...
//#endif
//
//__declspec(dllexport) CElemLib* __cdecl CreateInstance() {
//	return new CElemLib();
//}
//
//
...
//}
//
//BOOL CElement::IsArchRedrawRequired()
//{
//	BOOL RetVal;
//	pInterface->IsArchRedrawRequired(&RetVal);
//	return RetVal;
//}
//
//BOOL CElement::IsConstrRedrawRequired()
//{
//	BOOL RetVal;
//	pInterface->IsConstrRedrawRequired(&RetVal);
//	return RetVal;
//}
//
//void CElement::RedrawArchWnd() {
//	pInterface->RedrawArchWnd();
//}
//
//void CElement::RedrawConstrWnd() {
//	pInterface->RedrawConstrWnd();
//}
//
//CElemLib::CElemLib()
//{
...
//}
//
//CElement* CElemLib::CreateElement(const std::string& name, bool isArchMode) {
//
//}
