...
BOOL CDebugFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext) 
{
  ...
  //pRegsView->SetWindowContextHelpId(IDR_REGSVIEW+0x20000);
...
int CDebugFrame::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
  ...
  //lpCreateStruct->lpszName=FrameName;
  //HMENU hMenu=::LoadMenu(AfxGetInstanceHandle(),MAKEINTRESOURCE(IDR_DEBUGTYPE_ADD));
