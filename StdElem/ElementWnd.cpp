...
CElementWnd::CElementWnd(CElementBase* pElement)
{
...
void CElementWnd::scheduleRedraw() {
	m_isRedrawRequired = true;
}

bool CElementWnd::isRedrawRequired() {
	return m_isRedrawRequired;
}
