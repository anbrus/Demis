...
BOOL CButtonElement::Show(HWND hArchParentWnd, HWND hConstrParentWnd) {
	...
	pArchElemWnd.value()->Create(ClassName, "Кнопка", WS_VISIBLE | WS_OVERLAPPED | WS_CHILD | WS_CLIPSIBLINGS,
		CRect(0, 0, pArchElemWnd.value()->Size.cx, pArchElemWnd.value()->Size.cy), pArchParentWnd, 0);
	pConstrElemWnd.value()->Create(ClassName, "Кнопка", WS_VISIBLE | WS_OVERLAPPED | WS_CHILD | WS_CLIPSIBLINGS,
