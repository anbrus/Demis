...
BOOL CADCElement::Show(HWND hArchParentWnd, HWND hConstrParentWnd) {
	...
	pArchElemWnd.value()->CreateEx(styleEx, ClassName, "АЦП", WS_VISIBLE | WS_OVERLAPPED | WS_CHILD | WS_CLIPSIBLINGS | WS_CLIPCHILDREN,
		CRect(0, 0, pArchElemWnd.value()->Size.cx, pArchElemWnd.value()->Size.cy), pArchParentWnd, 0);
	pConstrElemWnd.value()->Create(ClassName, "АЦП", WS_VISIBLE | WS_OVERLAPPED | WS_CHILD | WS_CLIPSIBLINGS,
